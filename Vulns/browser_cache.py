...
def browser_cache(config_file):
    ...
    base_reusables.take_screenshot('Browser_cache/','1-Loggedin.png', config_file)
    
    webdriver_reusables.logout(browser, config_file)
    base_reusables.take_screenshot('Browser_cache/','2-Loggedout.png', config_file)
    
    browser.back()
    time.sleep(5)
    base_reusables.take_screenshot('Browser_cache/','3-backpressed.png', config_file)
    browser.quit()